...
export default function HomeScreen() {
  ...
  return (
    <View style={[styles.container, isPhone && styles.containerPhone]}>
      <Text style={[styles.title, isPhone && styles.titlePhone]}>Vault</Text>
      ...
      <Text style={[styles.listTitle, isPhone && styles.listTitlePhone]}>Demo Files</Text>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: "700", color: '#ffffff', marginBottom: 18, fontFamily: "dystropiax" },
