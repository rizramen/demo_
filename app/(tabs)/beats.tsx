...
export default function HomeScreen() {
  ...
  const { tracks, isLoading } = useTracks("beats");
  const isFocused = useIsFocused();
  const isVisible = useTabVisibility("beats");
  ...
  return (
    <View style={[styles.container, isPhone && styles.containerPhone]}>
      <Text style={[styles.title, isPhone && styles.titlePhone]}>Beats</Text>
      ...
      <Text style={[styles.listTitle, isPhone && styles.listTitlePhone]}>Beat Files</Text>
